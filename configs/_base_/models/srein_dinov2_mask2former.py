...
selected_classes = [12, 14, 5, 15]
# selected_classes = [16, 3, 9, 7]
# best 64.1100
# selected_classes = [0, 7, 9, 5, 17, 12, 1]
# selected_classes = [0, 7, 9, 12, 5, 17, 1, 3, 11, 13]
# selected_classes = [7, 8, 15, 3, 5, 14]
san_resnet = True
model = dict(
    type="EncoderDecoder",
    ...
    backbone=dict(
        ...
        init_cfg=dict(
            type="Pretrained",
            checkpoint="checkpoints/dinov2_vitl14_pretrain.pth_converted.pth",
        ),
    ),
    decode_head=dict(
